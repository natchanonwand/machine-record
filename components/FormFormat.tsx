...
const formatNumber = (value: number | undefined): string => {
  ...
  const overlayDataOnPDF = async (data: Record[], date: string, time: string): Promise<void> => {
    ...
    (
      ...
      // Draw the text on the second page with spacing between each record
      drawTextOnPage(secondPage, text, customFont, baseXOffset, yOffset - 1855, 7);
    }  else if 
    (
      ...
      // Draw the text on the second page with spacing between each record
      drawTextOnPage(secondPage, text, customFont, baseXOffset, yOffset - 1888, 7);
    } else if 
    (
      ...
      // Draw the text on the second page with spacing between each record
      drawTextOnPage(secondPage, text, customFont, baseXOffset, yOffset - 1922, 7);
    } else if 
    (
      ...
      // Draw the text on the second page with spacing between each record
      drawTextOnPage(secondPage, text, customFont, baseXOffset, yOffset - 1954, 7);
